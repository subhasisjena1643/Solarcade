    ...
    <div className="fixed inset-0 z-50 bg-black/80 flex items-center justify-center">
      ...
      >
        <div className="retro-window-header mb-4 flex justify-between items-center">
          <span style={{ fontSize: '12px' }}>🏆 GLOBAL LEADERBOARDS</span>
          <button 
            onClick={onClose}
        ...
        <div className="flex gap-2 mb-4">
          {games.map((game) => (
            <button
              ...
              className={`retro-button flex items-center gap-1 px-3 py-1 ${
                selectedGame === game.id ? 'bg-blue-600/30' : ''
              }`}
              style={{ fontSize: '8px' }}
            >
              <span>{game.icon}</span>
        ...
        <div className="mt-4 retro-panel p-3">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="text-center">
              ...
              <div className="pixel-text text-white" style={{ fontSize: '8px' }}>125 SOLAR</div>
            </div>
          </div>
        </div>
      </motion.div>
